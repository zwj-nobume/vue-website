...
const elems = ref(new Array(
    ...
    { name: 'permissionIdentifier', label: "权限标识", type: 'text', required: true },
))
...
const struct = ref(new Array(
    { name: "菜单名称", value: 'menuName', sortFlag: 'mi.menu_name', modifiable: true },
    { name: "菜单标签", value: 'menuLabel', sortFlag: 'mi.menu_label', modifiable: true },
    { name: "权限标识", value: 'permissionIdentifier', modifiable: true },
    { name: "创建人", value: 'createName', sortFlag: 'uic.user_name' },
    { name: "创建时间", value: 'createTime', sortFlag: 'mi.create_time' },
